...
from bcube.tensorflow import local_rank
from bcube.keras import callbacks


class _DistributedOptimizer(keras.optimizers.Optimizer):
    """
    This is an internal implementation class of Distributed Optimizer, not to be
    directly instantiated by end-users. See bcube.keras.DistributedOptimizer.
    """
...
def DistributedOptimizer(optimizer, name=None, device_dense='', device_sparse=''):
    ...
    # model could be easily restored without Bcube.
